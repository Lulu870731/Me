...
WHERE CONVERT(NVARCHAR(10),H.ISSUE_TIME,120) = '2024-12-05'
...
WHERE CONVERT(NVARCHAR(10),H.ISSUE_TIME,120) >= CONVERT(NVARCHAR(10),DATEADD(YEAR,-1, '2024-12-04') )

  AND CONVERT(NVARCHAR(10),H.ISSUE_TIME,120) < '2024-12-05'
...
WHERE CONVERT(NVARCHAR(10),H.ISSUE_TIME,120) >= CONVERT(NVARCHAR(10),DATEADD(M,-6, '2024-12-04') )
